...
async function main() {
  ...
  const pillars = [
    ...
    },
    {
      ...
      sanskritName: "Sandhya",
      description: "Twilight meditation at sunrise, noon, and sunset",
      category: "spirit",
      icon: "Sun",
      color: "#F97316",
      bgColor: "bg-orange-100",
    ...
    },
    {
      ...
      description: "Connect with the universal consciousness through study and reflection",
      category: "spirit",
      icon: "Infinity",
      color: "#A855F7",
    ...
    },
    {
      ...
      description: "Visualize and manifest your goals through focused intention",
      category: "spirit",
      icon: "Target",
      color: "#10B981",
